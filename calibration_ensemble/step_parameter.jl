using Tensorial, JLD2, Statistics
...
function step_parameter(parameters, observables, observed_data)
    ...
    next_generation_data = observed_data + randn(size(observed_data))
