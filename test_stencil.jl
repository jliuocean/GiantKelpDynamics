...
nodes = Nodes([0.0 0.0 4.0; ], zeros(1, 3), [4.0], [0.03], zeros(Int64, 1), zeros(1), [0.002], [0.5], zeros(1, 3), zeros(1, 3), zeros(1, 3), zeros(1, 3))
particle_struct = StructArray{GiantKelp}(([4.0], [0.0], [-8.0], [4.0], [4.0], [-8.0], [nodes]))

particles = LagrangianParticles(particle_struct; dynamics=kelp_dynamics!, parameters=(k = 10^5, α = 1.41, ρₒ = 1026.0, ρₐ = 1.225, g = 9.81, Cᵈˢ = 1.0, Cᵈᵇ=0.4*12^(-0.485), Cᵃ = 3.0)) 
